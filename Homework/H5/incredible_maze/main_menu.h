...
void highscoreMenu() {
  ...
  static int currentLevelStartAddress = 3 + highscoreLevel * 25;
  static int currentPositionStartAddress = currentLevelStartAddress + 5 * (highscorePosition - 1);
  lcd.setCursor(2, 1);
  lcd.print(EEPROM.read(currentPositionStartAddress));
  lcd.setCursor(3, 1);
  lcd.print(EEPROM.read(currentPositionStartAddress + 1));
  lcd.setCursor(4, 1);
  lcd.print(EEPROM.read(currentPositionStartAddress + 2));
  lcd.setCursor(5, 1);
  lcd.print(EEPROM.read(currentPositionStartAddress + 3));

  
  lcd.setCursor(7, 1);
  lcd.print(EEPROM.read(currentPositionStartAddress + 4));
